package com.clone.twitter.achievement_service.exception.handler;

import com.clone.twitter.achievement_service.exception.DataValidationException;
import com.clone.twitter.achievement_service.exception.DeserializeException;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleDeserializeException(DeserializeException e, HttpServletRequest request) {
        log.error("DeserializeException: {}", e.getMessage());
        return buildErrorResponse(e, request, HttpStatus.BAD_REQUEST);
    }
